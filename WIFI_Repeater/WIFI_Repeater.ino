...
const char* ssidExt = "Telecom-19108429";
const char* passwordExt = "Lvx0ISlawDIEYrNgokdeReaU";

const byte DNS_PORT = 53;
const byte DNS_PORT2 = 123;
...
void loop()
{
  ...
  if ( noBytes ) {
   Serial.print(millis() / 1000);
    ...
    Udp8.beginPacket(Udp.remoteIP(), Udp.remotePort()); //NTP requests are to port 123
